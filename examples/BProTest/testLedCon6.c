...
{
    printf("The key1 is detected, and press next key\n");
}
void myInterrupt2 (void)
{
    printf("The key2 is detected, and press next key\n");
}
void myInterrupt3 (void)
{
    printf("The key3 is detected, and press next key\n");
}
void myInterrupt4 (void)
{
    printf("The key4 is detected, and press next key\n");
}
void myInterrupt5 (void)
{
    printf("The key5 is detected, and press next key\n");
}
void myInterrupt6 (void)
{
    printf("The key6 is detected, and press next key\n");
}
void myInterrupt7 (void)
{
    printf("The key7 is detected, and press next key\n");
}
void myInterrupt8 (void)
{
    printf("The key8 is detected, and press next key\n");
}
void myInterrupt9 (void)
{
    printf("The key9 is detected, and press next key\n");
}
void myInterrupt10 (void)
{
    printf("The key10 is detected, and press next key\n");
}
void myInterrupt11 (void)
{
    printf("The key11 is detected, and press next key\n");
}
void myInterrupt12 (void)
{
    printf("The key12 is detected, and press next key\n");
}
void myInterrupt13 (void)
{
    printf("The key13 is detected, and press next key\n");
}
void myInterrupt14 (void)
{
    printf("The key14 is detected, key test over\n");
}
